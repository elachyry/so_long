...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   is_ghsot_touches_door.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: melachyr <melachyr@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/16 18:31:26 by melachyr          #+#    #+#             */
...
bool	is_ghsot_touches_door(t_ghost *app, int direction)
{
	int	ghost_directions[4];

	ghost_directions[0] = app->ghost_x_y[0] + 28;
	ghost_directions[1] = app->ghost_x_y[0] - 10;
	ghost_directions[2] = app->ghost_x_y[1];
	ghost_directions[3] = app->ghost_x_y[1];
